# studying for math exam, just watched hyper neutrino real quick
...
for current in positions:
    ...
    while True:
        ...
        if first_z is None: # makes sense
            first_z = current
            step_count = 0
...
lcm = nums.pop() # this is actually crazy -> the output will only ever be multiples, x, where final lcm of arr is len path
